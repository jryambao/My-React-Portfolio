...
const Home = () => {
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-row">
        <div className="flex flex-col justify-center h-full">
          ...
          <h2 className="text-4xl sm:text-7xl font-bold text-white text-center
            ...
            animate-text font-header mt-4">Frontend Developer</h2>
          <div className="flex justify-center mt-8">
          
          <a href={CV} download="CV" class="rounded-md relative inline-flex items-center justify-center h-12 px-6 overflow-hidden font-medium text-indigo-600 transition duration-300 ease-out border-2 border-purple-500 shadow-md group">
      ...
      <div className="2xl:fixed absolute icons"><Icons/></div>
